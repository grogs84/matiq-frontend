...
export const mockDoubleEliminationTournament = {
  ...
  matches: [
    ...
    { id: 15, name: "WB Final", nextMatchId: 17, tournamentRoundText: "3", startTime: "2024-03-22", state: "DONE", participants: [{ id: "p1", resultText: "15", isWinner: true, status: "PLAYED", name: "Marcus Johnson (Iowa)" }, { id: "p8", resultText: "12", isWinner: false, status: "PLAYED", name: "Henry Garcia (Nebraska)" }] },
    
    // Losers Bracket Final  
    { id: 16, name: "LB Final", nextMatchId: 17, tournamentRoundText: "4", startTime: "2024-03-23", state: "DONE", participants: [{ id: "p2", resultText: "14", isWinner: true, status: "PLAYED", name: "Tony Davis (Penn State)" }, { id: "p8", resultText: "11", isWinner: false, status: "PLAYED", name: "Henry Garcia (Nebraska)" }] },
    
    // Grand Final
    { id: 17, name: "Grand Final", nextMatchId: null, tournamentRoundText: "5", startTime: "2024-03-23", state: "DONE", participants: [{ id: "p1", resultText: "18", isWinner: true, status: "PLAYED", name: "Marcus Johnson (Iowa)" }, { id: "p2", resultText: "15", isWinner: false, status: "PLAYED", name: "Tony Davis (Penn State)" }] }
  ]
};